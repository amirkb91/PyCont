...
def initialguess_eig():
    ...
    eigfile = "/home/akb110/Codes/beam_cpp/examples/shallow_arch/shallow_arch_eig.h5"
...
def zerofunction(T, X, par):
    ...
    path2cpp = "/home/akb110/Codes/beam_cpp/examples/shallow_arch/"
    exec_cpp = "/home/akb110/Codes/beam_cpp/cmake-build-release/examples/shallow_arch"
    paramfile = "parameters.json"
    eigenfile = "shallow_arch_eig"
    ouputfile = "shallow_arch_out"
    ...
    cpp_parameter["Solver_parameters"]["number_of_steps"] = ns
    cpp_parameter["Solver_parameters"]["time"] = T[0]
    ...
    if cvg:
        ...
        dHdt = np.concatenate([Mm0[6:ndof_all, -1], Mm0[ndof_all + 6 :, -1]])
